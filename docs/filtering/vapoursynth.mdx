...
The second is [VSView](https://jaded-encoding-thaumaturgy.github.io/vs-view/), which is a standalone previewer with utilities for
tasks such as cropping, screenshotting, and uploading comparisons. It provides the option of an embedded Monaco-based code editor and integrated Python environment.
This tool is more advanced than Vapoursynth Editor.
